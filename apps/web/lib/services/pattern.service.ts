...
const PATTERNS: Pattern[] = [
  ...
  return NOT_FOUND`,
    ...
    problems: ['two-sum-sorted', 'valid-palindrome', 'three-sum', 'container-with-most-water', 'trapping-rain-water'],
  ...
  return maxSum`,
    ...
    problems: ['best-time-to-buy-sell-stock', 'longest-substring-without-repeating', 'minimum-size-subarray-sum', 'permutation-in-string', 'minimum-window-substring'],
    visualizerType: 'array',
    color: '#a855f7',
  },
  {
  ...
  return NOT_FOUND`,
    ...
    problems: ['binary-search', 'search-insert-position', 'find-minimum-rotated-sorted-array', 'search-rotated-sorted-array', 'median-two-sorted-arrays'],
    visualizerType: 'array',
    color: '#f59e0b',
  },
];
